      ...
      <div className="bg-[#1d4ed8]">
        ...
        <div>
          <p className="container px-5 mx-auto text-white mt-2 ">
            Subscribe for{" "}
            <span className=" font-semibold hover:font-bold cursor-pointer">
              Newsletter
            </span>
          </p>
          <div className="container mx-auto px-5 pt-6 pb-8 flex flex-wrap items-center justify-between ">
            <div className="w-full md:w-2/4 lg:w-1/3 h-16 flex items-center justify-center md:justify-start ">
              ...
              <CustomButton
                title="Subscribe"
                containerStyles={
                  "block bg-[#001a36] text-white px-5 py-2.5 text-md rounded hover:bg-opacity-80 focus:potline-none flex-col items-center mt-2"
                }
              />
            </div>
            <span className=' bg-zinc-600 p-3 rounded-md inline-flex lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto'>
              ...
              <a href="https://www.linkedin.com/in/akshat-tiwari-5a5617248/" target="blank" rel='noopener noreferrer'  className='ml-3  text-white text-xl  hover:scale-125 ease-in-out duration-300'>
                <FaLinkedinIn />
              </a>
            </span>
          </div>
        ...
        <div className='bg-[#001a36]'>
          <div className='container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row'>
            <p className='text-gray-300 text-sm text-center sm:text-left'>
              &copy; 2023 CarrerCraft —
              <a
                href='mailto:akshatcoding2k22@gmail.com'

    ...
    <>
      ...
      <div className="relative bg-[#f7fdfd] z-50">
        ...
        <li className="font-semibold">
          ...
          {/* Code below this is for mobile */}
           <div
          className={`${
            isOpen ? "absolute flex bg-[#f7fdfd] " : "hidden"
          } container mx-auto lg:hidden flex-col pl-8 gap-3 py-5`}
        >
          <Link to='/' onClick={handleCloseNavbar} className="hover:text-blue-700 font-semibold">
            Find Job
          </Link>
          <Link to='/companies' onClick={handleCloseNavbar}className=" hover:text-blue-700 font-semibold">
            Companies
          </Link>
          <Link
          ...
          <Link to='/about-us' onClick={handleCloseNavbar} className=" hover:text-blue-700 font-semibold">
            About
          </Link>
